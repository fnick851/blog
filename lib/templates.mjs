...
// The body carries the one link to the archive, styled as a command typed
// at the header's prompt; without it the home page reads as a profile card.
